...
func (rm *resourceManager) Get(
	...
	parent.Spec.AccessPolicy = &found.ko.Spec
	return nil
}
...
func convertFromParent(parent *svcapitypes.BackupVault) []resource {
	ko := &svcapitypes.AccessPolicy{}
	if parent.Spec.AccessPolicy != nil {
		ko.Spec = *parent.Spec.AccessPolicy
	}
	ko.Spec.BackupVaultName = parent.Spec.Name
	return []resource{{ko: ko}}
}

// NewSpecDelta returns a delta comparing two AccessPolicySpec values.
...
// comparison logic.
func NewSpecDelta(
	a *svcapitypes.AccessPolicySpec,
	b *svcapitypes.AccessPolicySpec,
) *ackcompare.Delta {
	var ra, rb *resource
	if a != nil {
		ra = &resource{ko: &svcapitypes.AccessPolicy{Spec: *a}}
	}
	if b != nil {
		rb = &resource{ko: &svcapitypes.AccessPolicy{Spec: *b}}
	}

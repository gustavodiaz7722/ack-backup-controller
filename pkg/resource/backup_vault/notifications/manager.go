...
func (rm *resourceManager) Get(
	...
	parent.Spec.Notifications = &found.ko.Spec
	return nil
}
...
func convertFromParent(parent *svcapitypes.BackupVault) []resource {
	ko := &svcapitypes.Notifications{}
	if parent.Spec.Notifications != nil {
		ko.Spec = *parent.Spec.Notifications
	}
	ko.Spec.BackupVaultName = parent.Spec.Name
	return []resource{{ko: ko}}
}

// NewSpecDelta returns a delta comparing two NotificationsSpec values.
...
// comparison logic.
func NewSpecDelta(
	a *svcapitypes.NotificationsSpec,
	b *svcapitypes.NotificationsSpec,
) *ackcompare.Delta {
	var ra, rb *resource
	if a != nil {
		ra = &resource{ko: &svcapitypes.Notifications{Spec: *a}}
	}
	if b != nil {
		rb = &resource{ko: &svcapitypes.Notifications{Spec: *b}}
	}
